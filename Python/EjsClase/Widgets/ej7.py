...
class MainWindow(QMainWindow): #nombre de la clase, cuando se empieza una clase se pone :
        ...
        def saberEstado(self, checkeda):
                print("¿Boton pulsado? -->", checkeda) # El segundo parametro de una función llamada por "boton.clicked.connect" es el estado del botón, nod ira si esta clikado
